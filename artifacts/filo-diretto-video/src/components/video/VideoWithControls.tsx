  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Ripeti scena: attivo' : 'Ripeti scena: disattivo'}
        aria-label={locked ? 'Ripeti scena: attivo' : 'Ripeti scena: disattivo'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        aria-label={collapsed ? 'Mostra controlli' : 'Nascondi controlli'}
